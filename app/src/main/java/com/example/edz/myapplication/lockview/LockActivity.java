package com.example.edz.myapplication.lockview;
...
//            Toast.makeText(LockActivity.this,"您绘制的密码是："+patternToString,Toast.LENGTH_SHORT).show();
            if (!TextUtils.isEmpty(patternToString)) {
                if (patternToString.equals(mima)) {
                    Toast.makeText(LockActivity.this, "您绘制的密码是：" + patternToString + "\n" + "密码正确，正在进入首页...", Toast.LENGTH_SHORT).show();
