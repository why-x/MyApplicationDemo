package com.example.edz.myapplication.camera.activity;
...
import com.example.edz.myapplication.camera.camera2.AutoFitTextureView;
import com.example.edz.myapplication.camera.camera2.CaptureLayout2;
import com.example.edz.myapplication.camera.camera2.CaptureListener2;
import com.example.edz.myapplication.camera.camera2.CustomVideoView;
import com.example.edz.myapplication.camera.camera2.util.BitmapDecoder;
import com.example.edz.myapplication.camera.camera2.util.BitmapSize;
import com.example.edz.myapplication.camera.camera2.util.Camera2Util;
import com.example.edz.myapplication.camera.camera2.util.CompareSizeByArea;
import com.example.edz.myapplication.camera.jcamera.listener.ClickListener;
import com.example.edz.myapplication.camera.jcamera.listener.TypeListener;
import com.example.edz.myapplication.camera.jcamera.util.ContentValue;
