package com.example.edz.myapplication.clickbanner.twoclickbanner;
...
public class ImageBigActivity extends AppCompatActivity {
    ...
    private class ImageScaleAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            ZoomImageView zoomImageView = new ZoomImageView(ImageBigActivity.this);
            //使用glide加载图片
            Glide.with(ImageBigActivity.this).load(imageUrls.get(position)).into(zoomImageView);
            //添加到容器container
