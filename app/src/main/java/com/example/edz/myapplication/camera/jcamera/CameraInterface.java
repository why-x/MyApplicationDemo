...
import com.example.edz.myapplication.camera.jcamera.util.AngleUtil;
import com.example.edz.myapplication.camera.jcamera.util.CameraParamUtil;
import com.example.edz.myapplication.camera.jcamera.util.CheckPermission;
import com.example.edz.myapplication.camera.jcamera.util.DeviceUtil;
